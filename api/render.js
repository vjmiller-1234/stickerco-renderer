...
async function renderSticker(composition) {
  ...
  // Kraft finish uses soft cream offset instead of white.
  // Everything else is identical — same size, same shape.
  ...
  // All other finishes are applied as post-processing.
